...
const SubHeader = ({ engineMode, setEngineMode }) => {
  return (
...
const Gauge = ({ value, dashoffset, color, textColor }) => {
  return (
...
const Footer = ({ onSaveScenario, onExecuteAcquisition }) => {
  return (
...
const SaveScenarioModal = ({ isOpen, onClose }) => {
...
const ExecuteModal = ({ isOpen, onClose }) => {
