...
const CheckboxItem = ({ label, defaultChecked }) => {
  ...
  return (
    <aside className="w-64 bg-[#11100e] border-r border-[#262420] flex flex-col h-full z-20 flex-shrink-0">
      ...
      <nav className="p-4 space-y-1 border-b border-[#262420]">
        {[
          { id: 'new', label: 'New Evaluation', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 4v16m8-8H4" /> },
          { id: 'fleet', label: 'Fleet Dashboard', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" /> },
          { id: 'comparison', label: 'Comparison Matrix', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> },
          { id: 'analytics', label: 'Market Analytics', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" /> },
        ].map(item => (
          <a
            key={item.id}
            href="#"
            onClick={e => { e.preventDefault(); setActiveNav(item.id); }}
            className={`flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeNav === item.id ? 'bg-[#1e1c19] text-cyan-400' : 'text-gray-400 hover:text-gray-200 hover:bg-[#1a1816]'}`}
          >
...
const RightPanel = () => {
  ...
  return (
    <aside className="w-[340px] bg-[#141311] border-l border-[#262420] flex flex-col h-full flex-shrink-0 z-20 shadow-[-10px_0_30px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-6" style={customStyles.scrollbarHide}>
        <div>
...
const AnomaliesPanel = () => {
  ...
  return (
    <section className="col-span-12 lg:col-span-4 bg-[#131210] border border-[#2a2825] rounded-xl shadow-sm flex flex-col h-[400px]">
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1" style={customStyles.scrollbarHide}>
        {anomalies.map((a, i) => (
...
const MarketAnalyticsPage = () => {
  return (
    <div className="flex-1 flex flex-col h-full bg-[#0a0905] relative z-10 min-w-0">
      ...
      <div className="flex-1 overflow-y-auto p-6 md:p-8" style={customStyles.scrollbarHide}>
